...
# Default local port matches ./run-vapi-local.sh (HTTP_LISTEN_ADDR).
#
...
set -euo pipefail
# Default port matches run-vapi-local.sh (127.0.0.1:8080).
PORT="${VAPI_LOCAL_PORT:-8080}"

cat << EOF
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Local Go → Tailscale Serve / Funnel  (proxy to 127.0.0.1:${PORT})
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
host’s tailscaled. So “outbound from Vapi” = inbound to YOU — only works if:
  ...
  • Funnel is enabled here (below), proxying to your Go process on 127.0.0.1:${PORT}.
...
1) Start the Go server (plain HTTP on 127.0.0.1):
     ./run-vapi-local.sh
   (Or set HTTP_LISTEN_ADDR in .env; override this help with VAPI_LOCAL_PORT=...)
...
2a) Tailnet-only — Serve (HTTPS on this machine, MagicDNS):
   ...
   Path-only mount (optional):
     sudo tailscale serve --bg --https=443 --set-path=/api/tools http://127.0.0.1:${PORT}
...
See also: ./tailscale-expose-vapi.sh (this file) — https://tailscale.com/kb/1223
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
EOF
